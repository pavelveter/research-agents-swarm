...
``research_swarm.search.providers.duckduckgo``.
...
Use ``from research_swarm.search import SearchOrchestrator`` instead.
"""
...
warnings.warn(
    "mcp_client.py is deprecated. Use research_swarm.search.providers.duckduckgo "
    "or research_swarm.search.SearchOrchestrator instead.",
    DeprecationWarning,
    stacklevel=2,
)
