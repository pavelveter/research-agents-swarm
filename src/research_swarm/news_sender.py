...
from research_swarm.logging_config import setup_terminal_logging, separator
...
async def run_news_sender(theme_path: Path | None = None) -> dict[str, bool]:
    ...
    if not channels:
        logger.warning("No channels enabled — set NEWS_SEND_EMAIL / NEWS_SEND_TELEGRAM / NEWS_SEND_DISCORD")
        return {}
